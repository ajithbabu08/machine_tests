...
import 'package:machine_test/firebase/dynamic%20link/product_detail.dart';
import 'package:machine_test/firebase/dynamic%20link/story.dart';
  ...
  buildDynamicLinks(String title,String image,String docId) async {
    ...
    final DynamicLinkParameters parameters = DynamicLinkParameters(
      ...
      androidParameters: AndroidParameters(
        packageName: "cloud_firestore: ^4.13.6",
        minimumVersion: 0,
      ),
